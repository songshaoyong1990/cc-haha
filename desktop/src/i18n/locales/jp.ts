...
export const jp: Record<TranslationKey, string> = {
  ...
  'skillCenter.marketplace.trust.official': '公式',
  'skillCenter.marketplace.trust.warning': '注意',
  'skillCenter.marketplace.trust.unknown': '不明',
  'skillCenter.marketplace.trust.blocked': 'ブロック',
  'skillCenter.marketplace.requiresApiKey': 'API キー',
  'skillCenter.marketplace.license': 'ライセンス',
  'skillCenter.marketplace.files': 'ファイル',
  'skillCenter.marketplace.downloads': 'ダウンロード',
  'skillCenter.marketplace.stars': 'スター',
  'skillCenter.marketplace.riskLabels': 'リスクシグナル',
  'skillCenter.marketplace.risk.allowed-tools': '許可ツール',
  'skillCenter.marketplace.risk.hooks': 'Hooks',
  'skillCenter.marketplace.risk.scripts': 'スクリプト',
  'skillCenter.marketplace.risk.executables': '実行ファイル',
