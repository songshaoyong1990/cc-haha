...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.activity.subtitleLoading': '基於本機 Claude Code CLI 會話記錄統計',
  ...
  'settings.diagnostics.doctorSafeKeys': '只會清理：cc-haha-open-tabs、cc-haha-session-runtime、cc-haha-theme、cc-haha-locale 和 cc-haha.persistence.schemaVersion。',
  ...
  'settings.adapters.description': '配置即時通訊介面卡，透過 Telegram、微信、釘釘、WhatsApp 或飛書與 Claude Code 對話。首次配置請參考',
  ...
  'settings.plugins.emptyHint': '先在 Claude Code 裡安裝外掛，桌面端就可以在這裡管理。',
  ...
  'skillCenter.marketplace.trust.official': '官方',
  'skillCenter.marketplace.trust.warning': '需留意',
  'skillCenter.marketplace.trust.unknown': '未知',
  'skillCenter.marketplace.trust.blocked': '已攔截',
  'skillCenter.marketplace.requiresApiKey': '需要 API Key',
  'skillCenter.marketplace.license': '授權',
  'skillCenter.marketplace.files': '檔案',
  'skillCenter.marketplace.downloads': '下載',
  'skillCenter.marketplace.stars': '星標',
  'skillCenter.marketplace.riskLabels': '風險訊號',
  'skillCenter.marketplace.risk.allowed-tools': '允許工具',
  'skillCenter.marketplace.risk.hooks': 'Hooks',
  'skillCenter.marketplace.risk.scripts': '腳本',
  'skillCenter.marketplace.risk.executables': '可執行檔',
  ...
  'skillCenter.marketplace.hint.sourceBody': '自動模式優先請求 ClawHub，需要時再切換備用源。',
