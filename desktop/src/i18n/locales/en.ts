export const en = {
  ...
  'skillCenter.marketplace.trust.official': 'Official',
  'skillCenter.marketplace.trust.warning': 'Warning',
  'skillCenter.marketplace.trust.unknown': 'Unknown',
  'skillCenter.marketplace.trust.blocked': 'Blocked',
  'skillCenter.marketplace.requiresApiKey': 'API key',
  'skillCenter.marketplace.license': 'License',
  'skillCenter.marketplace.files': 'Files',
  'skillCenter.marketplace.downloads': 'Downloads',
  'skillCenter.marketplace.stars': 'Stars',
  'skillCenter.marketplace.riskLabels': 'Risk signals',
  'skillCenter.marketplace.risk.allowed-tools': 'Allowed tools',
  'skillCenter.marketplace.risk.hooks': 'Hooks',
  'skillCenter.marketplace.risk.scripts': 'Scripts',
  'skillCenter.marketplace.risk.executables': 'Executables',
