...
export const zh: Record<TranslationKey, string> = {
  ...
  'skillCenter.marketplace.trust.blocked': '已拦截',
  'skillCenter.marketplace.requiresApiKey': '需要 API Key',
  'skillCenter.marketplace.license': '许可',
  'skillCenter.marketplace.files': '文件',
  'skillCenter.marketplace.downloads': '下载',
  'skillCenter.marketplace.stars': '星标',
  'skillCenter.marketplace.riskLabels': '风险信号',
  'skillCenter.marketplace.risk.allowed-tools': '允许工具',
  'skillCenter.marketplace.risk.hooks': 'Hooks',
  'skillCenter.marketplace.risk.scripts': '脚本',
  'skillCenter.marketplace.risk.executables': '可执行文件',
  ...
  'skillCenter.marketplace.hint.sourceBody': '自动模式优先请求 ClawHub，需要时再切换备用源。',
