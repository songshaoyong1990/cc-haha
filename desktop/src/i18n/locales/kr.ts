...
export const kr: Record<TranslationKey, string> = {
  ...
  'settings.activity.subtitleLoading': '로컬 Claude Code CLI 세션 기록을 기반으로 합니다',
  ...
  'settings.plugins.emptyHint': 'Claude Code에서 플러그인을 설치하면 여기서 관리할 수 있습니다.',
  ...
  'skillCenter.marketplace.trust.official': '공식',
  'skillCenter.marketplace.trust.warning': '주의',
  'skillCenter.marketplace.trust.unknown': '알 수 없음',
  'skillCenter.marketplace.trust.blocked': '차단됨',
  'skillCenter.marketplace.requiresApiKey': 'API 키',
  'skillCenter.marketplace.license': '라이선스',
  'skillCenter.marketplace.files': '파일',
  'skillCenter.marketplace.downloads': '다운로드',
  'skillCenter.marketplace.stars': '스타',
  'skillCenter.marketplace.riskLabels': '위험 신호',
  'skillCenter.marketplace.risk.allowed-tools': '허용 도구',
  'skillCenter.marketplace.risk.hooks': 'Hooks',
  'skillCenter.marketplace.risk.scripts': '스크립트',
  'skillCenter.marketplace.risk.executables': '실행 파일',
